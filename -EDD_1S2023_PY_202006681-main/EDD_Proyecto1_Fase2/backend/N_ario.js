...
function abrirVentana() {
    ...
    $('#ceder3').html(`<select id="miSelect3" >
                      ...
                      <a href="arbol_N.html" class="btn mt-3 btn-personalizado2 "> Cancelar </a>
...
function verifica(){
    ...
    if (username === "admin" && password === "admin") {
        ...
        window.location.href = "../-EDD_1S2023_PY_202006681/EDD_Proyecto1_Fase2/frontend/avl/avl.html";
    } else{
        ...
        if (NodoChetado!=null) {
            ...
            window.location.href = "../-EDD_1S2023_PY_202006681/EDD_Proyecto1_Fase2/frontend/arbol_nario/arbol_N.html";
        } else {
            if (localStorage.getItem(clave) != null) {
                localStorage.removeItem(clave);
            }
